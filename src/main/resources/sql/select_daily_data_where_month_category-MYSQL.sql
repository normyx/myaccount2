...
LEFT JOIN ( 
    ...
    GROUP BY bip.jhi_date, bi.account_id, bi.category_id, bip.month) AS budget_not_smoothed_unmarked  
...
WHERE rpt_dated_data.category_type <> 'OTHER' AND rpt_dated_data.account_id = :accountId AND rpt_dated_data.month = :month AND rpt_dated_data.category_id = :categoryId 
GROUP BY rpt_dated_data.jhi_date , rpt_dated_data.account_id, has_operation 
