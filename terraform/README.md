...
```
curl "https://nubesgen.com/myaccount.tgz?iactool=TERRAFORM&region=eastus&application=APP_SERVICE.free&runtime=SPRING&database=MYSQL.basic&gitops=true" | tar -xzvf -
```
